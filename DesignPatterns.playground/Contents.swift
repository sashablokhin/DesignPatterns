...
/*
Прототип (англ. Prototype) — паттерн создания объекта через клонирование другого объекта вместо создания через конструктор.
*/

// NSCopying для копирования ссылочных типов
